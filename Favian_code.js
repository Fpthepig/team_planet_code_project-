...
function calculateWeight(earthWeight) {
    ...
    for (let planet in planetWeights) {
        console.log(`Your weight on ${planets} is  ${planetWeights[planet]}kg`)
    }
    // ex: your weight on Mercury is xxKG.
    //ex: your weight on Venus is xxKG
    //etc
...
function getUserWeight() {
    ...
    console.log("Your weight on other,  is:");
